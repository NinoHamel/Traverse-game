         ...
         if(c == a+1 && d == b+1)
          {
          ...
          else if(c == a+1 && d == b-1)
           {
            ...
            int  condition_arret(pions traverse[10][10], int i , int j)
            {
           ...
           int possibilites(pions traverse[10][10],int i, int j) // fonction qui teste si tous les pions sont sortis de la position de départ //
